...
<div class="sidebar" id="mySidebar">
    <div class="side-header">
        ...
        <h5 style="margin-top:10px;">โรงพยาบาลสมเด็จพระบรมราชินีนาถ ณ อำเภอนาทวี จ.สงขลา</h5>
    </div>

    <hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>
    <a href="./index.php"><i class="fa fa-home"></i> Dashboard</a>
    <a href="#vnstat" onclick="showVnStat()"><i class="fa fa-location-arrow"></i> 22 ตัวชี้วัด รพ.</a>
    <a href="#orders" onclick="showOrders()"><i class="fas "></i> โรคเข้มมุ่ง</a>
